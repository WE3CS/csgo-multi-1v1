...
{
	name = "[CS:GO Multi 1v1] OneTap deagle round addon", 
	author = "Nocky", 
	description = "Adds an onetap deagle round-type", 
	version = "1.0", 
...
{
	LoadTranslations("multi1v1-onetap-dg.phrases");
	HookEvent("weapon_fire", Event_WeaponFire, EventHookMode_Post);
}

public void Multi1v1_OnRoundTypesAdded()
{
	Multi1v1_AddRoundType("★一发入魂(700$大狙)", "onetap-dg", OnetapdgHandler, true, false, "", true);
}

public void OnetapdgHandler(int client)
{
