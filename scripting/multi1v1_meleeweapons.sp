...
public void Multi1v1_OnRoundTypesAdded() 
{
	...
	Multi1v1_AddRoundType("★拳击肉搏", "fists", FistsHandler, true, false, "", true);
	Multi1v1_AddRoundType("★斧头大战", "axe", AxeHandler, true, false, "", true);
	Multi1v1_AddRoundType("★锤子大战", "hammer", HammerHandler, true, false, "", true);
	Multi1v1_AddRoundType("★扳手大战", "spanner", SpannerHandler, true, false, "", true);
	Multi1v1_AddRoundType("★电击枪大战", "taser", TaserHandler, true, false, "", true);
}
...
public void TaserHandler(int iClient) 
{
	// Start the custom round
	GivePlayerItem(iClient, "weapon_knife");
	int iMelee = GivePlayerItem(iClient, "weapon_taser");
	EquipPlayerWeapon(iClient, iMelee);
